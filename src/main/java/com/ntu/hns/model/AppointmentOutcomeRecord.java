...
public class AppointmentOutcomeRecord {
    ...
    @CsvBindByPosition(position = 1) private String typeOfService;
    @CsvBindByPosition(position = 2) private String consultationNotes;
    @CsvBindByPosition(position = 3) private List<MedicationItem> prescriptions;
    @CsvBindByPosition(position = 4) private String prescriptionStatus;
