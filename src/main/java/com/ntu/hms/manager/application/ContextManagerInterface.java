...
/**
 * The ContextManagerInterface defines methods for managing various user interactions in the context
 * of a healthcare management system. Implementations of this interface should handle the specifics
 * of how interactions for each type of user are managed and displayed.
 */
